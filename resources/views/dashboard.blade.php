            ...
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                         PLATFORM RESMI PEMESANAN STADION SULTAN AGUNG & FASILITAS
                    </h1>
                    <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        Temukan, pesan, dan nikmati pengalaman bermain di stadion olahraga terbaik
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="#" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white dark:text-gray-800 rounded-lg bg-four dark:bg-first">
                            Daftarkan Venue
                            <svg class="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                            </svg>
                        </a>
                        <a href="#venue-list" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                            Jelajahi Sekarang
                        </a>
                    </div>
                </div>
                ...
                <form method="GET" action="{{ route('dashboard') }}">
                    <div class="flex">
                        <div class="relative w-full">
                            ...
                            <button type="submit" class="absolute top-0 right-0 p-4 text-sm font-medium text-white bg-blue-700 rounded-r-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <section id="venue-list" class="bg-light dark:bg-dark py-10">
        <div class="container">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 dark:text-gray-400">{{ $stadions->count() }} berbagai macam fasilitas tersedia di platform kami</p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse ($stadions as $stadion)
                    <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transition-transform duration-300 hover:scale-105">
                        <a href="#">
                            <img class="rounded-t-lg h-48 w-full object-cover" src="{{ $stadion->foto ? asset('storage/' . $stadion->foto) : asset('images/default-venue.jpg') }}" alt="{{ $stadion->nama }}" />
                        </a>
                        <div class="p-5">
                            <a href="#">
                                <h3 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $stadion->nama }}</h3>
                            </a>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 line-clamp-2">{{ $stadion->deskripsi }}</p>
                            ...
                            <a href="{{ route('penyewaan-stadion.create', ['stadion_id' => $stadion->id]) }}" class="inline-flex items-center px-3 py-2 mt-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Booking Sekarang
                                <svg class="w-3.5 h-3.5 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                            </a>
                        </div>
                ...
                @empty
                    <div class="col-span-3 text-center py-16">
                        <div class="max-w-md mx-auto">
                            ...
                            <p class="mt-2 text-gray-500 dark:text-gray-400">Silakan coba dengan kriteria pencarian yang berbeda atau coba lagi nanti.</p>
                            <a href="{{ route('stadion.index') }}" class="inline-flex items-center px-4 py-2 mt-6 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Refresh Halaman
                            </a>
                        </div>
                    </div>
    ...
    <section class="bg-light dark:bg-dark py-16">
        <div class="container">
            <div class="text-center mb-12">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">KEUNGGULAN KAMI</h2>            </div>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center border border-gray-200 dark:border-gray-700 transition hover:-translate-y-2 duration-300">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center border border-gray-200 dark:border-gray-700 transition hover:-translate-y-2 duration-300">
                    <div class="mx-auto w-16 h-16 bg-amber-100 dark:bg-amber-900 rounded-full flex items-center justify-center mb-4">
                        <svg class="w-8 h-8 text-amber-600 dark:text-amber-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
