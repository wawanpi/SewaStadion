    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Tambahkan tarif baru untuk fasilitas berdasarkan kondisi waktu tertentu.
                </p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/30 flex items-center">
                ...
                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Formulir Harga Baru</h3>
            </div>

            <div class="p-8">
                <form method="POST" action="{{ route('harga-sewa.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative rounded-xl shadow-sm">
                                ...
                                <input type="number" name="harga" id="harga" min="0" step="1000" 
                                    ...
                                    placeholder="Masukkan nominal harga..." value="{{ old('harga') }}" required>
                            </div>
                            @error('harga')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="4" 
                                ...
                                placeholder="Jelaskan detail paket harga ini...">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
...
<script>
    ...
    const keteranganDefault = {
        ...
        'malam': 'Harga berlaku untuk jam malam (19-23 WIB).'
    };
