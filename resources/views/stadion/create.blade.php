    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Isi formulir di bawah untuk menambahkan fasilitas olahraga baru ke dalam sistem.
            </p>
        </div>

        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
            <div class="p-8">
                <form method="POST" action="{{ route('stadion.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama') }}" 
                                ...
                                placeholder="Contoh: Stadion Sultan Agung" required autofocus autocomplete="nama">
                            @error('nama')
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi') }}" 
                                    ...
                                    placeholder="Alamat Lengkap..." required autocomplete="lokasi">
                            </div>
                            @error('lokasi')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="4" 
                                ...
                                placeholder="Jelaskan fasilitas dan keunggulan stadion ini..." required>{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-2">
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Upload Foto Stadion</label>
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer group relative">
                                <div class="space-y-1 text-center pointer-events-none">
                                    ...
                                    <div class="flex text-sm text-gray-600 dark:text-gray-400 justify-center">
                                        <span class="font-medium text-indigo-600 hover:text-indigo-500">Upload foto</span>
