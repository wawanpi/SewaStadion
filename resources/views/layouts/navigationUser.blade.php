<nav x-data="{ open: false }" class="bg-white shadow-sm">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden sm:ml-10 sm:flex sm:space-x-8">
                    ...
                    <x-nav-link :href="route('penyewaan-stadion.my')" :active="request()->routeIs('penyewaan-stadion.my')" class="text-gray-800 hover:text-gray-600 hover:border-gray-500">
                        {{ __('Riwayat Pesanan') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div class="sm:hidden" x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('penyewaan-stadion.my')" :active="request()->routeIs('penyewaan-stadion.my')" class="block px-3 py-2 rounded-md text-base font-medium">
                {{ __('Riwayat Pesanan') }}
            </x-responsive-nav-link>
        </div>
